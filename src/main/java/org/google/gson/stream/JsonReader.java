...
package org.google.gson.stream;

import org.google.gson.internal.JsonReaderInternalAccess;
...
public class JsonReader implements Closeable {
  ...
  /**
   * Returns the next token, a {@link org.google.gson.stream.JsonToken#NAME property name}, and
   * consumes it.
   *
  ...
  /**
   * Returns the {@link org.google.gson.stream.JsonToken#STRING string} value of the next token,
  ...
  /**
   * Returns the {@link org.google.gson.stream.JsonToken#BOOLEAN boolean} value of the next token,
   * consuming it.
   *
  ...
  /**
   * Returns the {@link org.google.gson.stream.JsonToken#NUMBER double} value of the next token,
  ...
  /**
   * Returns the {@link org.google.gson.stream.JsonToken#NUMBER long} value of the next token,
   * consuming it. If the next token is a string, this method will attempt to
  ...
  /**
   * Returns the {@link org.google.gson.stream.JsonToken#NUMBER int} value of the next token,
   * consuming it. If the next token is a string, this method will attempt to
