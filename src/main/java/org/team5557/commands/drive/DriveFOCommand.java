...
public class DriveFOCommand extends CommandBase {
    private SwerveSubsystemMK2 drivetrainSubsystemMK2;
    private Axis forward;
    private Axis strafe;
    private Axis rotation;

    public DriveFOCommand(SwerveSubsystemMK2 drivetrain, Axis forward, Axis strafe, Axis rotation) {
    ...
    @Override
    public void execute() {
        drivetrainSubsystemMK2.drive(new Vector2(forward.get(true), strafe.get(true)), rotation.get(true), false);
    }
